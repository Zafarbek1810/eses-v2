...
const TABS: { id: TabId; label: string; description: string; icon: React.ElementType }[] = [
  ...
  { id: "baseLaboratories", label: "Global laboratoriyalar", description: "Barcha tashkilotlar uchun", icon: Globe },
  { id: "baseAnalyses", label: "Global analizlar", description: "Umumiy analiz katalogi", icon: Globe },
  { id: "pdf", label: "PDF shablon", description: "Tashkilot shablonlari", icon: FileType },
  { id: "globalPdf", label: "Global PDF shablon", description: "Umumiy PDF katalogi", icon: Globe },
];
