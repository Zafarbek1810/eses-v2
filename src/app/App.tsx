...
const Header = ({
  ...
  return (
    <div className="sticky top-0 z-40 px-4 pt-3 pb-1 shrink-0">
      <header className="h-[58px] flex items-center px-3 gap-3 rounded-2xl border border-border bg-card/90 backdrop-blur-md shadow-sm">
        {/* Page title */}
